...
float error_val_Y = 10; // how much error for leg angle in yaw is allowd
float error_val_P = 10; // how much error for leg angle in pitch is allowd
float error_val_R = 10; // how much error for leg angle in roll is allowd
